  ...
  return (
    <>
      <div className="flex items-center justify-center">
        ...
        {type === "xl" && (
          <div
            className="relative cursor-pointer z-0 h-40 w-40"
            onMouseEnter={() => setHover(true)}
            onMouseLeave={() => setHover(false)}
          >
            <div
              className={`z-10 bg-photopicker-overlay-background h-40 w-40 absolute top-0 left-0 flex items-center rounded-full justify-center flex-col text-center gap-2
