  ...
  return (
    <div className="h-16 px-3 py-3 flex justify-between items-center">
      ...
      <div className="flex flex-row  gap-6">
        <Link
          href="/showpdf"
          className="w-full flex items-center justify-center text-center rounded-md bg-orange-50  text-base font-medium text-black-800 ring-1  ring-inset transition hover:bg-orange-100"
        >
          <h1 className="items-center justify-center"> Our Course's</h1>
        </Link>
